 ...
 (function() {
     ...
     const myQuestions = [{
            question: "1. What is the complexity of quick sort?", ///// Write the question inside double quotes
            answers: {
                a: "Best case O(n*log(n)) ", ///// Write the option 1 inside double quotes
                ...
                d: "Average case O(n*log(n)) ", ///// Write the option 2 inside double quotes
		e: "a, b and c ", ///// Write the option 2 inside double quotes
            },
            correctAnswer: "e" ///// Write the correct option inside double quotes
        },

    {
      question: "2. What is the space complexity of the quick sort algorithm in best case?",  ///// Write the question inside double quotes
      answers: {
